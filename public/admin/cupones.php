                    ...
                    <tr>
                        ...
                        <td>
                            <?php 
                                ...
                                if (!$c['activo']) {
                                    echo '<span class="tag tag-error">INACTIVO</span>';
                                } elseif ($is_expired) {
                                    echo '<span class="tag tag-error">EXPIRADO</span>';
                                } elseif ($is_full) {
                                    echo '<span class="tag tag-error">AGOTADO</span>';
                                } else {
                                    echo '<span class="tag tag-success">ACTIVO</span>';
                                }
                            ?>
                        </td>
                        <td>
